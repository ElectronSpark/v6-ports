...
add_definitions(-DPKGLIBEXECDIR="/libexec/webkit2gtk-${WEBKITGTK_API_VERSION}")
add_definitions(-DLOCALEDIR="/share/locale")
add_definitions(-DDATADIR="/share")
add_definitions(-DLIBDIR="/lib")
add_definitions(-DPKGLIBDIR="/lib/webkit${WEBKITGTK_API_INFIX}gtk-${WEBKITGTK_API_VERSION}")
...
# xv6: keep the GTK injected bundle enabled. WebKit expects it at runtime,
# and GLib constructor ordering is handled by the main executable.
